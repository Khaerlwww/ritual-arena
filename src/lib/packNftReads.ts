...
// Shared RitualPackNFT V10 read helpers. The struct returned by
// `cardData(tokenId)` matches contracts/pack/RitualPackNFT.sol V10:
...
/**
 * V10 CardData struct from RitualPackNFT.cardData(tokenId).
